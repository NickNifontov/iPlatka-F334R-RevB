...
void MX_DAC1_Init(void)
{
  ...
  */
  sConfig.DAC_Trigger = DAC_TRIGGER_HRTIM1_DACTRG1;
  ...
  */
  if (HAL_DACEx_TriangleWaveGenerate(&hdac1, DAC_CHANNEL_1, DAC_TRIANGLEAMPLITUDE_7) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_DAC2_Init(void)
{
  ...
  */
  ...
  /** DAC channel OUT1 config 
  */
  sConfig.DAC_Trigger = DAC_TRIGGER_HRTIM1_DACTRG3;
  sConfig.DAC_OutputSwitch = DAC_OUTPUTSWITCH_ENABLE;
