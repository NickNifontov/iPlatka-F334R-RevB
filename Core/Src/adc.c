...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  AnalogWDGConfig.LowThreshold = 2001;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC1_IN11 
    */
    GPIO_InitStruct.Pin = ADC_V_OP_Pin|ADC_V_Pin|ADC_TEMP_Pin|ADC_RAW_Pin;
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PC4     ------> ADC2_IN5 
    */
    GPIO_InitStruct.Pin = ADC_I_OP_Pin|ADC_16V_Pin|ADC_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN11 
    */
    HAL_GPIO_DeInit(GPIOA, ADC_V_OP_Pin|ADC_V_Pin|ADC_TEMP_Pin|ADC_RAW_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC4     ------> ADC2_IN5 
    */
    HAL_GPIO_DeInit(GPIOC, ADC_I_OP_Pin|ADC_16V_Pin|ADC_I_Pin);
