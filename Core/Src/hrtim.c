...
void MX_HRTIM1_Init(void)
{
  ...
  hhrtim1.Init.HRTIMInterruptResquests = HRTIM_IT_FLT2|HRTIM_IT_SYSFLT;
  ...
  pCompareCfg.CompareValue = 37760;
...
void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspInit 0 */
    ...
    PB7     ------> HRTIM1_EEV3 
    */
    GPIO_InitStruct.Pin = FLT_ONOFF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_HRTIM1;
    HAL_GPIO_Init(FLT_ONOFF_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = IGLA_EE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_HRTIM1;
    HAL_GPIO_Init(IGLA_EE_GPIO_Port, &GPIO_InitStruct);
...
void HAL_HRTIM_MspDeInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspDeInit 0 */
    ...
    PB7     ------> HRTIM1_EEV3 
    */
    HAL_GPIO_DeInit(IGLA_GPIO_Port, IGLA_Pin);

    HAL_GPIO_DeInit(GPIOA, INA_Pin|INB_Pin|FLT_ONOFF_Pin);

    HAL_GPIO_DeInit(IGLA_EE_GPIO_Port, IGLA_EE_Pin);
